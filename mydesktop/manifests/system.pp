class mydesktop::system () {
  ...
  $tools_cli = [ 'git', 'puppet', 'htop', 'nmap', 'lynx', 'wget', 'whois', 'ipcalculator', 'figlet', 'telnet', 'traceroute', 'samba-client', 'samba-common', 'autofs', 'putty', 'tmux', 'vim-enhanced', 'python-pip', 'iperf3', 'p7zip', 'p7zip-plugins' ]
